CREATE DATABASE  IF NOT EXISTS `ordermanagement` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `ordermanagement`;
...
CREATE TABLE `orders` (
  ...
  PRIMARY KEY (`id`),
  KEY `orders_ibfk_2` (`clientID`),
  CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`clientID`) REFERENCES `client` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
